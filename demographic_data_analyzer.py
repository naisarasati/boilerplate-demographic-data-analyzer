...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv("/Users/macbookair/boilerplate-demographic-data-analyzer/adult.data.csv")
    print(df.head())
    ...
    high_salary_percentage = round((high_earners['native-country'].value_counts() / df['native-country'].value_counts()) * 100, 0)
    ...
    IN_earned_50K = df[(df["salary"] == ">50K") & (df["native-country"] == "India")]
    top_IN_occupation = IN_earned_50K["occupation"].mode()
